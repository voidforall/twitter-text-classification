...
train_datapath = r"./data/train_subset_ex.json"
valid_datapath = r"./data/valid_subset_ex.json"
...
max_len = 50
train_inputs, train_masks, train_types = dataprepare.bert_tokenize_ex(train_set, tokenizer, max_len)
valid_inputs, valid_masks, valid_types = dataprepare.bert_tokenize_ex(valid_set, tokenizer, max_len)
...
validation_data = TensorDataset(valid_inputs, valid_masks, valid_types, valid_labels)
...
output_dir = './saved/bert_subset_ex/'
